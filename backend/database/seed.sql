...
-- PostgreSQL 16 compatible seed data for GigTix
...
VALUES -- Admin users
    (
        ...
        '$2b$10$J366x9pSlEECPKoub9Hv3uhPM59geQVnaoQq4cViUDMJuMzNXdoc2',
        'admin',
        NOW(),
        NOW()
    ),
...
VALUES -- John Doe's reservations
    (
...
SELECT name,
    ...
    ROUND(
        (
            ("totalSeats" - "availableSeats")::DECIMAL / "totalSeats" * 100
        ),
        2
...
/*
 ...
 Bcrypt hash: $2b$10$J366x9pSlEECPKoub9Hv3uhPM59geQVnaoQq4cViUDMJuMzNXdoc2
